...
The "Firsts" Advantage: Backers are most attracted to tangible, traditional media "firsts." The keyword "Album" is the single most powerful driver of funded projects.

Physical Dominance: In Tech and Design, success is extremely narrow; almost all funding goes to Hardware and Product Design, leaving very little for software or digital-only concepts.

The "Hub" Effect: Success isn't about being in a mega-city. Smaller, high-trust creative hubs like Edinburgh (90.5% success) outperform global centers like Brooklyn.

2. Performance Trends & Comparison

The Funding Gap: Technology and Design creators set high goals but hit them most accurately. Publishing and Fashion creators are the most over-ambitious, often raising only a tiny fraction of their ask.

Launch Day Dead-Zone: While mid-week launches are consistent, Saturday is a clear outlier for failure, as potential backers are less likely to engage with crowdfunding platforms on weekends.

The Magnitude of Viral Success: Super-successes (like Oculus) don't just "hit" goals; they blow past them by millions, proving that crowdfunding has a "winner-take-all" viral ceiling.

3. Flow & Distribution

Low-Cost Mass Appeal: "The Crowd" strategy (low cost, mass appeal) has a 93.7% success rate, proving you don't need high-ticket items to succeed if your volume is high.

Buy-in Friction: Successful projects keep their entry-level rewards under $200. Failed projects often attempt to set their lowest "buy-in" far too high, killing momentum.

Niche Flow: Creative "niche" categories like Dance, Theater, and Comics have a much smoother flow toward success than broad, high-competition categories like Technology.

4. Success Drivers & Indicators

The "Danger Zone": The highest concentration of failures occurs at the 30-day mark for goals under $10,000. This is where lack of preparation meets the reality of the platform.

Backer Unit Value: Technology backers spend the most per person ($140), whereas Games and Comics require a much larger "volume" of people to reach the same goal due to lower average spends ($45).

The Social Proof Paradox: A Facebook presence is required for legitimacy, but a high Facebook friend count has a very low correlation (0.07) with actually winning, meaning you must market to strangers to succeed.

## top 5/6 overall
The Communication Factor (Updates): Overachievers (500%+) average 12.8 updates. High-frequency communication is the strongest non-financial predictor of massive success.

The Social Infrastructure: While personal friend counts are "vanity metrics," having a dedicated Facebook Page and a Project Video are the ultimate deal-makers for establishing trust and a landing pad for backers.

The "Sweet Spot" Tier: Successful projects focus their high-tier rewards in the $1k–$2k range. "Impossible" $10k tiers exist in both failed and successful projects, but the $2k "VIP" tier is where the real revenue density lives.

Crowd Volume > Duration: Success is driven by the size of the crowd (0.86 correlation), not the length of the campaign. Adding more days often leads to a loss of urgency rather than more funds.

Seasonal Timing: Launching in June yields a 72.4% success rate, while launching in December is a statistical "graveyard" (42%) due to holiday donor fatigue.

Psychological Anchoring: Using specific "Power Words" like "Affordable" paradoxically attracts higher average pledges ($533) by signaling a "high-value deal" to premium buyers.

## category and market insights
1. Creator Persona: Value vs. Volume
Insight: Most creators are stuck in the "Struggles" phase; moving to "Star" status requires a rare "double threat" of high prices and massive popularity.

Reasoning: The scatter plot shows the heaviest density in the bottom-left quadrant (Struggles). To reach the green Stars quadrant, a creator must simultaneously maintain a high average pledge (vertical axis) and a high backer count (horizontal axis), which very few manage to do.

2. Cities by Success Rate
Insight: High success isn't about being in a "big" city; smaller, specialized creative hubs like Edinburgh are much more effective for crowdfunding.

Reasoning: Edinburgh leads the list with a 90.5% success rate, beating out massive global centers like Brooklyn or Barcelona. This suggests that smaller, high-trust communities provide better support for local projects.

3. Keywords of Success: Top Terms in Titles
Insight: Backers are most attracted to "firsts" and physical, traditional media. The word "Album" is the single most powerful driver of funded projects.

Reasoning: The bar chart shows "Album" with a frequency of over 1,200, followed by "Film" and "Debut." This indicates that the audience specifically looks for clear, tangible outcomes and the excitement of a creator’s first professional release.

4. Funding Goal Target Amount Distribution
Insight: Creators rely on "psychological round numbers" like $5,000 and $10,000 to set their goals, rather than calculating exact project costs.

Reasoning: There are massive, thin spikes at exactly the $5k and $10k marks. These "peaks" show that creators believe these specific numbers feel more "fundable" or professional to the average donor.

5. The "Mountain Range" of Goal Distributions
Insight: Different industries have completely different "normal" costs; Technology projects typically ask for 10x more than Art or Dance projects.

Reasoning: This "ridge plot" shows the "hump" for Technology and Film shifted much further to the right toward the $10k–$100k range, while Art and Dance peaks are much closer to the $1k mark.

6. Pledgers by Category (Treemap)
Insight: Video Games and Narrative Film are the "community kings." They don't just raise money; they attract the highest volume of individual people.

Reasoning: In this area-based chart, Video Games (792k) and Narrative Film (160k) have the largest blocks. This means these categories are best at "going viral" and building a massive fan base.

7. Pledge Amount by Minor Category (Bar Chart)
Insight: Within the gaming world, Video Games are the undisputed heavyweight, earning more than double the next most successful sub-category (Documentaries).

Reasoning: The yellow bar for Video Games reaches a massive $45M, creating a huge gap between it and "Documentaries" or "Tabletop Games," which sit in the $15M–$20M range.

8. Pledge Amount by Major Category (Bar Chart)
Insight: There is a "Top 5" elite group of categories (Games, Film, Design, Tech, Music) that captures the vast majority of all crowdfunding dollars.

Reasoning: The drop-off after the top five categories is steep. Games ($80M) and Film ($54M) dominate, while categories like "Dance" or "Photography" struggle to break $3M.

9. Funding Hierarchy: Major to Minor Breakdown
Insight: Success in "Design" and "Technology" is extremely narrow; almost all the money goes to Product Design and Hardware, leaving very little for software or graphics.

Reasoning: Looking at the "Design" and "Technology" boxes, the sub-sections for Product Design and Hardware take up nearly the entire space. This shows that backers in these categories primarily want to fund physical inventions they can eventually own.
