...
df_info = df[['PhoneServices','TotalCharges']]
df_agg = df_info.groupby('PhoneServices').agg(Total_Charges = ('TotalCharges', 'sum')).reset_index()
df_agg.columns = ['PhoneServices','Total Charges']
df_agg.sort_values("Total Charges", ascending=True)
output = px.bar(df_agg, x="PhoneServices", y="Total Charges")
st.plotly_chart(output)
...
df_agg.columns = ['PaperlessBilling','Total Charges']
df_agg.sort_values("Total Charges", ascending=True)
output = px.bar(df_agg, x="PaperlessBilling", y="Total Charges")
st.plotly_chart(output)
